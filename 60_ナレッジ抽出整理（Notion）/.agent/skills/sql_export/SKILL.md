---
name: sql_export
description: Notion の SQL集を NotebookLM 向け Markdown にエクスポートし、テーブル関係サマリーを自動生成するスキル。「SQL集を取得して」「NotebookLM用にエクスポートして」「sql_knowledge.md を更新して」などのリクエストに対して使用する。
---
